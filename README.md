...
1. **Download the Model**  
   First, download the model you want to use from (https://zenodo.org/records/15806706) and move it into the `run-predictions/models` folder.
...
#### Usage Example:
```bash
python3 predict.py models/model.pt test-files/sample-taste-txt.tsv predictions/predictions-test-en.tsv --device 0
```
